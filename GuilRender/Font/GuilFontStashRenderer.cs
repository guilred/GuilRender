...
public class GuilFontStashRenderer(GuilBatch Batch) : IFontStashRenderer2 {
    ...
    private static GuilVertex getVertex(VertexPositionColorTexture vpct) {
        return new GuilVertex(vpct.Position, vpct.TextureCoordinate, 0, vpct.Color, default, default);
    }
}